    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 via-white to-gray-200 pb-24">
      ...
      <div className="w-full max-w-xl mx-auto p-4">
        <div className="backdrop-blur-lg bg-white/80 rounded-2xl shadow-xl p-6 mb-6 animate-fade-in">
          <h1 className="text-4xl font-extrabold text-gray-800 mb-2 tracking-tight drop-shadow-lg flex items-center gap-2">
            <span className="inline-block bg-gradient-to-r from-gray-700 to-gray-400 text-white px-3 py-1 rounded-xl shadow">SafeZone</span>
            <span className="text-base font-normal text-gray-400 ml-2">MVP</span>
          </h1>
          <p className="text-lg text-gray-600 mb-4">Describe your situation for instant safety advice.</p>
          <InputBox onAnalyze={onAnalyze} />
          {loading && <p className="text-base text-gray-500 mt-2 animate-pulse">Analyzing...</p>}
          {error && <p className="text-base text-red-500 mt-2">{error}</p>}
          <div className="flex justify-center gap-6 mt-6">
            <a className="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-full shadow transition text-base font-semibold" href="/resources">Resources</a>
